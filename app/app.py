...
def create_email_signature():
    ...
    output_dir = os.path.abspath(os.path.join(app.root_path, '..', 'outputs'))
    ...
    file_metadata = {
        ...
        'parents': [google_drive_folder_id],  # ID da pasta do Google Drive onde deseja armazenar as imagens
    }
